...
#--------------------------------------------------------------------------------
class lpc_remote_files(QWidget):
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.pushButton_lpc_remote_files.clicked.connect(self.open_lpc_remote_files)
    ...
    def open_lpc_remote_files(self):
        self.lpc_remote = lpc_remote_files(self.laptop_list)
        self.lpc_remote.setWindowTitle('Laptops Remote Files Manager')
