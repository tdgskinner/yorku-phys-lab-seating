...
class FileCopierApp(QMainWindow):
    def __init__(self):
        ...
        # Add QTextEdit for file names to be deleted
        self.delete_label = QLabel("File Names to Delete (enter one file per line):")
    ...
    def delete_files(self):
        ...
        delete_filenames = self.delete_input.toPlainText().splitlines()

        for filename in delete_filenames:
            file_to_delete = os.path.join(client_path, self.destination_input.text().strip(), filename.strip())
