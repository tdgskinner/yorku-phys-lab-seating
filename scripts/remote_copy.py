...
class MyWebServer:
    ...
    def run_webserver(self):
        try:
            ...
            logging.info('Html files are copied in all group PCs successfully!')
        except:
            logging.error('Unable to copy files in group Pcs')
    ...
    def reboot_Pcs(self):
        try:
            ...
            logging.info('Reboot command sent to all group PCs successfully!')
        except:
            logging.error('Unable to send reboot command to group PCs')
